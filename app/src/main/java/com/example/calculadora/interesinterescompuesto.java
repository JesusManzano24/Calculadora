...
public class interesinterescompuesto extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_interesinterescompuesto);
            ...
            Menu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(interesinterescompuesto.this, MainActivity2.class);
            ...
            Regresar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(interesinterescompuesto.this, menuinteressimple.class);
                    startActivity(intent);
                }
            });
        }
